...
import { parse as nbtParse, simplify } from 'https://deno.land/x/nbt_parser@v1.3.0/index.ts';
import type { NBTInventoryItem } from '../helpers/TransformItemData.ts';

export async function parse(value: Uint8Array | number[] | string): Promise<NBTInventoryItem[]> {
